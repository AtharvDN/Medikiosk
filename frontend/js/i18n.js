...
export const translations = {
  en: {
    ...
    // Phase 10B Patient Dashboard & Portal
    dashboardBadge: "Patient Care Dashboard",
    hello: "Hello",
    dashboardWelcomeDesc: "Welcome to MediKiosk Self-Service Health Portal.",
    recordMyCase: "Record My Case",
    recordMyCaseDesc: "Record a new clinical episode with voice and touch assistance",
    recordMyCaseBadge: "~3 mins · Voice Enabled",
    todayConsultation: "Upcoming Consultation",
    ayushDept: "Ayush & Integrative Medicine OPD",
    room12: "Room 12 · Attending Doctor · Est. wait: 10 mins",
    waitingForCall: "Waiting for Call",
    healthServices: "Your Health Services",
    healthHistory: "My Health History",
    healthHistoryDesc: "View past visits, consultations, and recorded episodes.",
    medicalRecords: "Medical Records & Reports",
    medicalRecordsDesc: "Scanned prescriptions, lab reports, and diagnostic documents.",
    healthSummary: "My Health Summary",
    healthSummaryDesc: "Consolidated health passport with active meds and allergies.",
    profileConsent: "Profile & Privacy Consent",
    profileConsentDesc: "Manage demographic details and ABDM consent preferences.",
    needKioskHelp: "Need Assistance?",
    kioskHelpDesc: "Approach hospital helpdesk counter for guided kiosk support.",
    helpDeskCounter: "Helpdesk Counter 1",
    recordNewCase: "Record New Case",
    ...
    exitKioskSession: "Exit Kiosk Session",
  ...
  hi: {
    ...
    // Phase 10B Patient Dashboard & Portal
    dashboardBadge: "रोगी देखभाल डैशबोर्ड",
    hello: "नमस्ते",
    dashboardWelcomeDesc: "मेडीकियोस्क स्व-सेवा स्वास्थ्य पोर्टल में आपका स्वागत है।",
    recordMyCase: "मेरी नई केस दर्ज करें",
    recordMyCaseDesc: "आवाज और स्क्रीन की सहायता से नया नैदानिक इतिहास दर्ज करें",
    recordMyCaseBadge: "~३ मिनट · आवाज समर्थित",
    todayConsultation: "आज का परामर्श",
    ayushDept: "आयुष व इंटीग्रेटिव मेडिसिन ओपीडी",
    room12: "कमरा १२ · चिकित्सक उपस्थित · प्रतीक्षित समय: १० मिनट",
    waitingForCall: "पुकार की प्रतीक्षा",
    healthServices: "आपकी स्वास्थ्य सेवाएं",
    healthHistory: "मेरा स्वास्थ्य इतिहास",
    healthHistoryDesc: "पिछली मुलाकातों और दर्ज मामलों की सूची देखें।",
    medicalRecords: "चिकित्सा दस्तावेज व रिपोर्ट",
    medicalRecordsDesc: "स्कैन किए गए नुस्खे, लैब रिपोर्ट और नैदानिक फाइलें।",
    healthSummary: "मेरा स्वास्थ्य सारांश",
    healthSummaryDesc: "सक्रिय दवाओं और एलर्जी का समेकित डिजिटल पासपोर्ट।",
    profileConsent: "प्रोफाइल व गोपनीयता संमती",
    profileConsentDesc: "व्यक्तिगत विवरण और एबीडीएम साझाकरण प्राथमिकताएं प्रबंधित करें।",
    needKioskHelp: "सहायता चाहिए?",
    kioskHelpDesc: "कियोस्क सहायता के लिए अस्पताल सहायता केंद्र से संपर्क करें।",
    helpDeskCounter: "सहायता काउंटर १",
    recordNewCase: "नया केस दर्ज करें",
    viewDetails: "विवरण देखें",
    activeMedications: "सक्रिय दवाइयाँ",
    knownAllergies: "ज्ञात दवा एलर्जी",
    recordedVitals: "दर्ज वाइटल्स",
    notRecorded: "दर्ज नहीं",
    backToDashboard: "डैशबोर्ड पर लौटें",
    exitKioskSession: "सत्र समाप्त करें",
  ...
  mr: {
    ...
    // Phase 10B Patient Dashboard & Portal
    dashboardBadge: "रुग्ण काळजी डॅशबोर्ड",
    hello: "नमस्कार",
    dashboardWelcomeDesc: "मेडीकिऑस्क स्वयं-सेवा आरोग्य पोर्टलमध्ये आपले स्वागत आहे.",
    recordMyCase: "माझी केस नोंदवा",
    recordMyCaseDesc: "आवाज व स्क्रीनच्या साहाय्याने नवीन आरोग्य इतिहास नोंदवा",
    recordMyCaseBadge: "~३ मिनिटे · आवाज समर्थित",
    todayConsultation: "आजची सल्लामसलत",
    ayushDept: "आयुष व इंटिग्रेटिव्ह मेडिसिन ओपीडी",
    room12: "खोली १२ · डॉक्टर: उपस्थित · अंदाजे वेळ: १० मिनिटे",
    waitingForCall: "बोलावण्याची प्रतीक्षा",
    healthServices: "तुमच्या आरोग्य सेवा",
    healthHistory: "माझा आरोग्य इतिहास",
    healthHistoryDesc: "मागील भेटी व नोंदवलेल्या केसेस तपासा.",
    medicalRecords: "वैद्यकीय नोंदी व अहवाल",
    medicalRecordsDesc: "स्कॅन केलेले कागदपत्रे व लॅब रिपोर्ट.",
    healthSummary: "माझा आरोग्य सारांश",
    healthSummaryDesc: "औषधे व ऍलर्जींचा एकत्रित तपशील.",
    profileConsent: "प्रोफाइल व संमती",
    profileConsentDesc: "वैयक्तिक माहिती आणि ABDM संमती व्यवस्थापित करा.",
    needKioskHelp: "मदत हवी आहे का?",
    kioskHelpDesc: "कियोस्क मदतीसाठी रुग्णालय मदत कक्षाशी संपर्क साधा.",
    helpDeskCounter: "मदत कक्ष काउंटर १",
    recordNewCase: "नवीन केस नोंदवा",
    viewDetails: "तपशील पहा",
    activeMedications: "सक्रिय औषधे",
    knownAllergies: "माहित असलेली ऍलर्जी",
    recordedVitals: "नोंदवलेले व्हायटल्स",
    notRecorded: "नोंदवलेले नाही",
    backToDashboard: "डॅशबोर्डवर परत जा",
    exitKioskSession: "सत्र समाप्त करा",
    savePreferences: "प्राधान्ये जतन करा",
    savedSuccessfully: "यशस्वीरित्या जतन झाले",
